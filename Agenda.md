...
- Визначена система формування назв елементів стилізації: **<Назва елемента>_<sh>_<Type "number">**:
   ...
   - **<Type "number">** де номер це порядковий номер запропонованої стилізації від команди "lazyHamsters" для даного блоку/елементу, нормер "0" - відповідає варіанту без вказання розміру блоку/елементу.
