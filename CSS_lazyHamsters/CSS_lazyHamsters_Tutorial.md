# Проєкт бібліотеки стилізованих елементів (блоків) банди lazyHamsters (draft ver.01 12.00 10/10/2021).
...
- Визначена система формування назв елементів стилізації: **"Назва елемента"-lh_V + номер**:
